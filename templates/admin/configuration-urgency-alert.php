<tr valign="top">
    ...
    <td>
        <label for="<?php echo $urgencyAlertEnabled; ?>">
            <input type="checkbox" name="<?php echo $urgencyAlertEnabled; ?>" <?php echo (boolval(esc_attr(get_option($urgencyAlertEnabled))) === true) ? "checked" : ""; ?> />
            Is feature enabled?
        </label>
    </td>
</tr>
<tr valign="top">
    ...
    <td><input type="number" min="0" max="999999" step="1" name="<?php echo $daysThreshold; ?>" value="<?php echo esc_attr(stripslashes(get_option($daysThreshold))); ?>" /><br />
...
<tr valign="top">
    ...
    <td><input type="number" min="0" max="999999" step="1" name="<?php echo $minimumVisitors; ?>" value="<?php echo esc_attr(stripslashes(get_option($minimumVisitors))); ?>" /><br />
        <label for="<?php echo $minimumVisitors; ?>">Minimum visitors number required for text to be displayed.</label>
    </td>
</tr>
<tr valign="top">
    <th scope="row">Text</th>
    <td><input type="text" placeholder="Default will be used." name="<?php echo $text; ?>" value="<?php echo esc_attr(stripslashes(get_option($text))); ?>" /><br />
...
<tr valign="top">
    ...
    <td><input type="text" placeholder="Not defined." name="<?php echo $highlightedText; ?>" value="<?php echo esc_attr(get_option($highlightedText)); ?>" /><br />
