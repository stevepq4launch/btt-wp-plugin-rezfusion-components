  ...
  <td>
    <select name="rezfusion_hub_sync_items_post_type">
      <?php foreach (get_post_types([], 'object') as $slug => $post_type) : ?>
        <option value="<?php print $slug  ?>" <?php selected($slug, get_rezfusion_option(Options::syncItemsPostType(), PostTypes::listing())); ?>>
...
<tr valign="top">
  ...
  <td>
    <input type="text" name="rezfusion_hub_custom_listing_slug" value="<?php echo esc_attr(get_rezfusion_option(Options::customListingSlug())); ?>" />
    <br />
...
<tr valign="top">
  ...
  <td>
    <input type="text" name="rezfusion_hub_custom_promo_slug" value="<?php echo esc_attr(get_rezfusion_option(Options::customPromoSlug())); ?>" />
    <br />
...
<tr valign="top">
  ...
  <td>
    <input type="text" name="rezfusion_hub_promo_code_flag_text" value="<?php echo esc_attr(get_rezfusion_option(Options::promoCodeFlagText())); ?>" />
    <br />
...
<tr valign="top">
  ...
  <td>
    <input type="text" name="<?php echo Options::repositoryToken(); ?>" value="<?php echo esc_attr(get_rezfusion_option(Options::repositoryToken())); ?>" />
    <br />
