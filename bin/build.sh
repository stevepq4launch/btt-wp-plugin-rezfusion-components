...
docker-compose exec -T wordpress bash -c "wp option update --allow-root rezfusion_hub_env $BLUEPRINT_ENVIRONMENT && wp option update  --allow-root rezfusion_hub_channel $BLUEPRINT_CHANNEL"
